                    ...
                    <div class="justify-content-end d-flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-custom">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Middle Section Form</span></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <h4 class="card-title">Middle Section form</h4>
                    </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::textArea('description', null, ['class' => 'form-control','id'=>'summernote', 'placeholder' => 'Enter Description', 'required']) !!}
                </div>
                ...
                <div class="form-group" id="image">
                    ...
                    <div class="row">
                        ...
                        <div class="image-preview mt-2  ml-2">
                            @if (!empty($object->image) && file_exists("uploads/middleSection/" . $object->image))
                            {{ Form::label('image', 'Image',['class'=>'mr-2']) }}
                                <img style="background:thistle;max-height: 150px;"
                                    src={{ asset('uploads/middleSection/' . $object->image) }} />
                            @endif
                        </div>
                    </div>
                </div>
